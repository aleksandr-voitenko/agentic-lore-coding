...
| [Development](../.lore-coding/instructions/development.md) | Handle assumptions, plan changes, implement, and retain task evidence. | Implementation planning or file edits. |
...
| [Memory writing](../.lore-coding/instructions/memory-writing.md) | Maintain compact, scoped project knowledge. | Creating, updating, splitting, or compacting memory. |
...
Reading history does not require commit-authoring instructions. Reading memory does not require memory-writing instructions. Keep task evidence throughout development; defer only its final formatting and commit procedure.
